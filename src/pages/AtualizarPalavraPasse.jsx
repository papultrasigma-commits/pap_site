...
// Adicionamos a propriedade "onSuccess"
export default function UpdatePassword({ onSuccess }) {
  ...
  // Limpa o lixo visual do link assim que a página abre
  useEffect(() => {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      // 🚀 CORREÇÃO PRINCIPAL: Avisa a porta de entrada para fechar e deixar-te ver o site!
      setTimeout(() => {
        sessionStorage.removeItem("pws_is_recovering");
        if (onSuccess) {
           onSuccess(); 
        } else {
